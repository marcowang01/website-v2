...
export const metadata = {
  title: 'Marco Wang',
  description:
    'Software Engineer. Building AI agents at rabbit. Creating tools to help people learn, create and connect. Physics/Computer Science at Northwestern University.',
