...
const expericences = {
  work: [
    ...
    },
    {
      ...
      bulletpoints: [
        'Developed a full-stack fleet maintenance tracking platform, reducing vehicle downtime and consolidating 100+ monthly maintenance tickets with 30+ hour monthly time savings',
    ...
    },
    {
      ...
      bulletpoints: [
        ...
        'Automated a critical weekly font upload process by building a browser-based client, reducing time spent by 90%',
